...
import { insertUserSchema, insertCategorySchema, insertProductSchema, insertTableSchema, 
  ...
  insertBrewerySettingsSchema, insertProductVariationSchema } from "@shared/schema";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.use(session({
    secret: process.env.SESSION_SECRET || 'bierserv-production-secret-key-very-secure',
    resave: false,
